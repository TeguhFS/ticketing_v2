<x-app-layout>
    ...
    <div class="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        @foreach ([['label' => 'Total Event', 'value' => $stats['total'], 'icon' => 'ti-calendar-event', 'color' => 'bg-gray-900'], ['label' => 'Published', 'value' => $stats['published'], 'icon' => 'ti-circle-check', 'color' => 'bg-emerald-500'], ['label' => 'Draft', 'value' => $stats['draft'], 'icon' => 'ti-pencil', 'color' => 'bg-amber-500'], ['label' => 'Cancelled', 'value' => $stats['cancelled'], 'icon' => 'ti-circle-x', 'color' => 'bg-red-500']] as $stat)
                    ...
                    @foreach ($events as $event)
                        ...
                        <div
                            ...
                            <div class="p-4">
                                ...
                                <h3 class="text-sm font-semibold text-gray-900 mb-2 line-clamp-2">{{ $event->title }}
                                </h3>
